...
import 'package:roadwise/presentation/bloc/course/course_bloc.dart';
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      title: Text(course.title ?? 'Unknown Course', style: const TextStyle(color: Colors.white)),
                      subtitle: Text(course.imageSrc ?? '', style: const TextStyle(color: Colors.white70)),
